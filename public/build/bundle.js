...
var app = (function () {
    ...
    /* src/routes/LandingPage.svelte generated by Svelte v3.59.2 */
    ...
    function instance$2($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<LandingPage> was created with unknown prop '${key}'`);
    	});
    ...
    /* src/routes/WebApp.svelte generated by Svelte v3.59.2 */

    const { console: console_1 } = globals;
    const file = "src/routes/WebApp.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Web Application";
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('WebApp', slots, []);
    	let { params } = $$props;
    	console.log('Rendering WebApp with params:', params);

    	$$self.$$.on_mount.push(function () {
    		if (params === undefined && !('params' in $$props || $$self.$$.bound[$$self.$$.props['params']])) {
    			console_1.warn("<WebApp> was created without expected prop 'params'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<WebApp> was created with unknown prop '${key}'`);
    	});
    ...
    class WebApp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get params() {
    		throw new Error("<WebApp>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set params(value) {
    		throw new Error("<WebApp>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_default_slot(ctx) {
    	...
    	route1 = new Route({
    			props: { path: "/app/*", component: WebApp },
    			$$inline: true
    		});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Link, LandingPage, WebApp });
    	return [];
    }
